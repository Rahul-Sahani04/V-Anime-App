    ...
    <div className='app'>
      <div className="content-image">
        ...
        <div className='w-2/6 object-contain flex items-center bg-slate-800 rounded-full overflow-hidden px-2 py-1 justify-end transition-all duration-300 ease-in-out shadow-lg'>
          <input className='transition-all duration-500 ease-in-out indent-4  text-gray-200 text-lg flex-grow outline-none focus:caret-slate-900 border-4 border-slate-800 bg-slate-800 focus:border-lime-500 object-contain h-[55px] rounded-full mr-2 ' type='text' onChange={(e) => setQuery(e.target.value)} />
