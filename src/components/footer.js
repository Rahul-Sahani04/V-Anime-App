...
function Custom_Footer() {
    ...
    return (
        <footer className="bg-[#1f1f1f]">
            <div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-12">
                <div className="grid grid-cols-1 gap-8 ">
                    <div>
                        ...
                        <p
                            className="mx-auto mt-6 leading-relaxed text-center text-gray-400  sm:mx-0 sm:text-left"
                        >
                        ...
                        <ul className="flex justify-center gap-6 mt-8 md:gap-8 sm:justify-start">
                            ...
                            <li>
                                <a
                                    href="https://www.instagram.com/shemademeapoetry/"
                                    rel="noopener noreferrer"
                                    target="_blank"
                                    className="text-teal-500 transition hover:text-teal-500/75"
                                >
