...
function Recom(props) {
    ...
    var _e = useState(false), dataLoaded = _e[0], setDataLoaded = _e[1];
    ...
    var fetchRecom = function (page_no) { return __awaiter(_this, void 0, void 0, function () {
        var response, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setIsLoading(true);
                    return [4 /*yield*/, fetch("https://api.consumet.org/anime/gogoanime/recent-episodes?page=".concat(page_no))];
                case 1:
                    response = _a.sent();
    ...
    return (React.createElement("div", null,
        React.createElement("div", { className: 'container', key: "D-ID" }, recomList.map(function (recom, index) { return (React.createElement("div", { className: 'card-here' },
            React.createElement(Card_Component, { theme_mode: props.theme, className: 'anime-card', id: recom.id, title: recom.title, image: recom.image, key: "ID" + index }))); })),
